...
public class WMS_Chasewave_Sorter_Location extends WMS_WebDriverUtilities {

	WebDriver driver;

	public WMS_Chasewave_Sorter_Location(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	@FindBy(xpath = "//ion-row[@class='ng-star-inserted md hydrated']")
	public WebElement expandopenElement;
	...
	public WebElement lpnshipElement;
	 ...
	 */
	public List<HashMap<String, String>> returnLPNTableforPutCart(List<HashMap<String, String>> itemDataTable,
			String TotStart, String TOTKey, String CartKey, int CartSlot, String Lpn,
			List<HashMap<String, String>> data_ItemTable) {
		int TOTint;
		int Cartint;
		int TOTstartint;
		int Numberoftotes;
	...
	public List<HashMap<String, String>> updateLPNTableforPutCart(List<HashMap<String, String>> data_ItemTable,
			String Lpn, String Key, String Field, String Val) {
		for (HashMap<String, String> row : data_ItemTable) {
	...
	public String getFieldValueForLPNTable(List<HashMap<String, String>> data_ItemTable, String Key1, String Key2,
			String Field) {
	...
	public WebElement getHeaderTableFromLPNDetail(String Key) {
		String findelementstring = "//div[@class='expand-header-container'][span='" + Key
				+ "']/parent::expand-child/div[@class='expand-content ng-star-inserted']/div[@class='scroll-panel ng-star-inserted']/*//datatable-header/*//div[@class='datatable-row-center ng-star-inserted']";
	...
	public WebElement getDataTableFromLPNDetail(String Key) {
		String findelementstring = "//div[@class='expand-header-container'][span='" + Key
				+ "']/parent::expand-child/div[@class='expand-content ng-star-inserted']/div[@class='scroll-panel ng-star-inserted']/*//datatable-body/*//datatable-scroller";
	...
	public void enterLpnSearch(String Lpn) {
			...
			if (LPNSearchElementExpand.isDisplayed()) {
				...
				clickElement(LPNSearchElement);
				enterText(LPNSearchElement, Lpn);
				...
				clickElement(LPNSearchElementExpand);
				new WebDriverWait(driver, 1).until(ExpectedConditions.visibilityOf(LPNSearchElement));
				clickElement(LPNSearchElement);
				enterText(LPNSearchElement, Lpn);
				pressEnterKey(LPNSearchElement);
	...
	public void clickitemRmlpn() {
		try {
			new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOf(lpnitemPage));
			clickElement(lpnitemPage);
		} catch (Exception e) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].click();", lpnitemPage);
		}
	...
	public String getAsnSearchVal() {
		...
		try {
			...
			// new
			// WebDriverWait(driver,30).until(ExpectedConditions.visibilityOf(ASNSearchElement));
	...
	public void clickDrpitem() {
		try {
			new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(clickitemElement));
	...
	public void clickClose() {
		...
		try {
			new WebDriverWait(driver, 60).until(ExpectedConditions.elementToBeClickable(closeIconElement));
